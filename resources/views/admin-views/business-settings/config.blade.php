    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <span class="badge badge-soft-primary white--space text-left">{{__('messages.map_api_hint')}} {{__('messages.map_api_hint_2')}}</span>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-label text-capitalize">{{__('messages.map_api_key')}} ({{__('messages.client')}})</label>
                                <input type="text" placeholder="Ex: {{__('messages.map_api_key')}} ({{__('messages.client')}})" class="form-control h--45px" name="map_api_key"
                                    value="{{env('APP_MODE')!='demo'?$map_api_key??'':''}}" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-label text-capitalize">{{__('messages.map_api_key')}} ({{__('messages.server')}})</label>
                                <input type="text" placeholder="Ex: {{__('messages.map_api_key')}} ({{__('messages.server')}})" class="form-control h--45px" name="map_api_key_server"
