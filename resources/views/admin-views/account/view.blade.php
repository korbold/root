...
<div class="content container-fluid">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-3">
        <h2 class="page-header-title text-capitalize m-0">
            {{__('messages.account_transaction')}} {{__('messages.information')}}
        </h2>
    </div>
    <div class="row g-2">
            ...
            <div class="card h-100">
                <div class="card-header">
                    <h5 class="card-title">
                        ...
                        <span>{{$account_transaction->restaurant?__('messages.restaurant'):__('messages.deliveryman')}} {{__('messages.info')}}</span>
                    </h5>
                </div>
                <div class="card-body">
            ...
            <div class="card h-100">
                <div class="card-header">
                    <h5 class="card-title">
                        ...
                        <span>{{__('messages.transaction')}} {{__('messages.information')}}</span>
                    </h5>
                </div>
                <div class="card-body">
