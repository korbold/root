    ...
    <div class="row g-2">
        ...
        <div class="col-md-4 col-6">
            <a href="{{route('vendor.food.view',[$item['id']])}}" class="grid-card top--rated-food pb-4">
                <center>
                    <img style="border-radius: 5px;width: 65px;height: 65px" src="{{asset('storage/app/product')}}/{{$item['image']}}" onerror="this.src='{{asset('assets/admin/img/100x100/2.png')}}'" alt="{{$item->name}} image">
                </center>
