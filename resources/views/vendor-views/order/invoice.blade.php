        ...
        <div class="row" id="printableArea" style="font-family: emoji;">
            ...
            <div style="max-width:376px;margin:0 auto;padding-left:10px;padding-right:10px">
                ...
                <div class="text-center pt-2 mb-3">
                    ...
                    @endif
                    {{-- <span style="text-align:center">Gst: {{$order->restaurant->gst_code}}</span> --}}
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-6">
                        <h5>{{ translate('Order ID') }} :
                            <span style="font-weight:400"> {{ $order['id'] }} </span>
                        </h5>
                    </div>
                    <div class="col-6">
                ...
                <table class="table table-bordered mt-1 mb-1">
                    <thead>
                        <tr>
                            <th style="width: 10%;padding: 0.45rem 0.65rem;border-bottom:none">{{ translate('messages.qty') }}</th>
                            <th class="" style="padding: 0.45rem 0.65rem;border-bottom:none">{{ translate('DESC') }}</th>
                            <th class="" style="padding: 0.45rem 0.65rem;border-bottom:none">{{ translate('messages.price') }}</th>
                        </tr>
                    </thead>
                ...
                <div class="mb-3" style="width: 98%; margin-left: auto;margin-right:auto">
                    <div class="px-3">
                        <dl class="row text-right">
                            ...
                            <dt class="col-6 text-left" style="font-size: 20px">{{ translate('messages.total') }}:</dt>
                ...
                <div class="d-flex flex-row justify-content-between border-top pt-3">
                    <span class="text-capitalize">{{ translate('Paid by') }}: {{ str_replace('_', ' ', $order['payment_method']) }}</span>
                ...
                <h5 class="text-center pt-1">
                    ...
                    {{-- <span style="display:block;text-align:center;">&copy; 2022 All Right Reserved by</span>
                    <span style="display:block;text-align:center;">6amtech Limited</span> --}}
                <span style="display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:1;overflow:hidden;white-space:nowrap">---------------------------------------------------------------------------------</span>
            </div>
        </div>
    </div>
