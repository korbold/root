                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    <dt class="col-6">{{ __('messages.items') }} {{ __('messages.price') }}:</dt>
                                    <dd class="col-6">
                                        {{ \App\CentralLogics\Helpers::format_currency($sub_total) }}</dd>
                                    <dt class="col-6">{{ __('messages.addon') }} {{ __('messages.cost') }}:</dt>
                                    <dd class="col-6">
                                    ...
                                    <dt class="col-6">{{ __('messages.coupon') }} {{ __('messages.discount') }}:
                                    </dt>
                                    <dd class="col-6">
                                        -
                                    ...
                                    <dt class="col-6">{{ __('messages.delivery') }} {{ __('messages.fee') }}:
                                    </dt>
                                    <dd class="col-6">
