                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title text-capitalize">
                        <div class="card-header-icon d-inline-flex mr-2 img">
                            <img src="<?php echo e(asset('/public/assets/admin/img/business.png')); ?>" alt="public">
                        </div>
                        <span>
                            <?php echo e(__('messages.business')); ?>

                        <?php echo e(__('messages.setup')); ?>
            ...
            <div class="col-md-12 mb-3">
                <div class="card">
                    <div class="card-body mb-3">
                        ...
                        <p class="mt-2 mb-0">
                            <?php echo e(translate('*By turning on maintaince mode, all your app and customer side website will be off. Only admin panel and seller panel will be functional')); ?>
                ...
                <form action="<?php echo e(route('admin.business-settings.update-setup')); ?>" method="post"
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center"> <span class="card-header-icon mr-2"><i class="tio-user"></i></span> <span>Genaral <?php echo e(__('messages.info')); ?></span></h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1"><?php echo e(__('messages.business')); ?>
                            ...
                            <div class="row gy-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(__('messages.address')); ?></label>
                                    ...
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(__('messages.footer')); ?>

                                            <?php echo e(__('messages.text')); ?></label>
                                    ...
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"
                                            for="latitude"><?php echo e(__('messages.latitude')); ?><span class="input-label-secondary"
                                                 data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(__('messages.click_on_the_map_select_your_defaul_location')); ?>"><img
                                                    src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                    alt="<?php echo e(__('messages.click_on_the_map_select_your_defaul_location')); ?>"></span></label>
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="input-label text-capitalize d-flex alig-items-center"
                                            for="longitude"><?php echo e(__('messages.longitude')); ?><span class="input-label-secondary"
                                                 data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(__('messages.click_on_the_map_select_your_defaul_location')); ?>"><img
                                                    src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                    alt="<?php echo e(__('messages.click_on_the_map_select_your_defaul_location')); ?>"></span></label>
                                ...
                                <div class="col-lg-6">
                                    <input id="pac-input" class="controls rounded overflow-hidden initial-9"
                                        title="<?php echo e(__('messages.search_your_location_here')); ?>" type="text"
                                        placeholder="<?php echo e(__('messages.search_here')); ?>" />
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center"> <span class="card-header-icon mr-2"><i class="tio-neighborhood"></i></span> <span><?php echo e(__('messages.business')); ?> <?php echo e(__('messages.info')); ?></span></h4>
                        </div>
                        <div class="card-body pb-0">
                            <div class="row">
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <label class="input-label mt-2"> <?php echo e(__('messages.logo')); ?> <small class="text-danger">* ( <?php echo e(__('messages.ratio')); ?> 300x100 )</small></label>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <label class="input-label mt-2"> <?php echo e(__('messages.Fav Icon')); ?><small class="text-danger">* ( <?php echo e(__('messages.ratio')); ?> 150x150 )</small></label>
                                        <div class="custom-file mb-3">
                                            <input type="file" name="icon" id="favIconUpload" class="custom-file-input"
                                                accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                            <label class="custom-file-label" for="favIconUpload"><?php echo e(__('messages.choose')); ?>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"
                                            for="country"><?php echo e(__('messages.country')); ?></label>
                                ...
                                <div class="col-md-4 col-sm-6 col-12">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(__('messages.currency')); ?></label>
                                ...
                                <div class="col-md-4 col-sm-6 col-12">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"
                                            for="currency_symbol_position"><?php echo e(__('messages.currency_symbol_positon')); ?></label>
                                ...
                                <div class="col-md-4 col-sm-6 col-12">
                                    <div class="form-group language--setup">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(trans('messages.language')); ?> </label>
                                        <select name="language[]" id="language" data-maximum-selection-length="3"
                                            ...
                                            title="<?php echo e(__('messages.add_language_warrning')); ?>">
                                ...
                                <div class="col-md-4 col-sm-6 col-12">
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="input-label text-capitalize d-flex alig-items-center"><?php echo e(__('messages.time_zone')); ?></label>
                                        <select name="timezone" class="form-control js-select2-custom">
                                            <option value="UTC" <?php echo e($tz ? ($tz == '' ? 'selected' : '') : ''); ?>>UTC</option>
                                            <option value="Etc/GMT+12" <?php echo e($tz ? ($tz == 'Etc/GMT+12' ? 'selected' : '') : ''); ?>>
                                                (GMT-12:00)
                                            ...
                                            <option value="America/Los_Angeles"
                                                <?php echo e($tz ? ($tz == 'America/Los_Angeles' ? 'selected' : '') : ''); ?>>(GMT-08:00)
                                                Pacific Time
                                                (US & Canada)</option>
                                            <option value="America/Tijuana"
                                                <?php echo e($tz ? ($tz == 'America/Tijuana' ? 'selected' : '') : ''); ?>>
                                                (GMT-08:00) Tijuana, Baja California</option>
                                            <option value="US/Arizona" <?php echo e($tz ? ($tz == 'US/Arizona' ? 'selected' : '') : ''); ?>>
                                                (GMT-07:00)
                                                Arizona</option>
                                            ...
                                            <option value="US/Central" <?php echo e($tz ? ($tz == 'US/Central' ? 'selected' : '') : ''); ?>>
                                                (GMT-06:00)
                                                Central Time (US & Canada)</option>
                                            <option value="America/Mexico_City"
                                                <?php echo e($tz ? ($tz == 'America/Mexico_City' ? 'selected' : '') : ''); ?>>(GMT-06:00)
                                                Guadalajara,
                                                Mexico City, Monterrey</option>
                                            <option value="Canada/Saskatchewan"
                                                <?php echo e($tz ? ($tz == 'Canada/Saskatchewan' ? 'selected' : '') : ''); ?>>(GMT-06:00)
                                                Saskatchewan
                                            </option>
                                            <option value="America/Bogota"
                                                <?php echo e($tz ? ($tz == 'America/Bogota' ? 'selected' : '') : ''); ?>>
                                                (GMT-05:00) Bogota, Lima, Quito, Rio Branco</option>
                                            <option value="US/Eastern" <?php echo e($tz ? ($tz == 'US/Eastern' ? 'selected' : '') : ''); ?>>
                                                (GMT-05:00)
                                            ...
                                            <option value="Canada/Newfoundland"
                                                <?php echo e($tz ? ($tz == 'Canada/Newfoundland' ? 'selected' : '') : ''); ?>>(GMT-03:30)
                                                Newfoundland
                                            </option>
                                            ...
                                            <option value="America/Montevideo"
                                                <?php echo e($tz ? ($tz == 'America/Montevideo' ? 'selected' : '') : ''); ?>>(GMT-03:00)
                                                Montevideo
                                            </option>
                                            ...
                                            <option value="Atlantic/Cape_Verde"
                                                <?php echo e($tz ? ($tz == 'Atlantic/Cape_Verde' ? 'selected' : '') : ''); ?>>(GMT-01:00)
                                                Cape Verde Is.
                                            </option>
                                            ...
                                            <option value="Asia/Amman" <?php echo e($tz ? ($tz == 'Asia/Amman' ? 'selected' : '') : ''); ?>>
                                                (GMT+02:00)
                                                Amman</option>
                                            ...
                                            <option value="Asia/Kabul" <?php echo e($tz ? ($tz == 'Asia/Kabul' ? 'selected' : '') : ''); ?>>
                                                (GMT+04:30)
                                                Kabul</option>
                                            <option value="Asia/Yekaterinburg"
                                                <?php echo e($tz ? ($tz == 'Asia/Yekaterinburg' ? 'selected' : '') : ''); ?>>(GMT+05:00)
                                                Yekaterinburg
                                            </option>
                                            ...
                                            <option value="Asia/Dhaka" <?php echo e($tz ? ($tz == 'Asia/Dhaka' ? 'selected' : '') : ''); ?>>
                                                (GMT+06:00)
                                                Astana, Dhaka</option>
                                            ...
                                            <option value="Asia/Kuala_Lumpur"
                                                <?php echo e($tz ? ($tz == 'Asia/Kuala_Lumpur' ? 'selected' : '') : ''); ?>>(GMT+08:00) Kuala
                                                Lumpur,
                                                Singapore</option>
                                            ...
                                            <option value="Asia/Taipei"
                                                ...
                                                Taipei</option>
                                            <option value="Asia/Tokyo" <?php echo e($tz ? ($tz == 'Asia/Tokyo' ? 'selected' : '') : ''); ?>>
                                                (GMT+09:00)
                                                Osaka, Sapporo, Tokyo</option>
                                            <option value="Asia/Seoul" <?php echo e($tz ? ($tz == 'Asia/Seoul' ? 'selected' : '') : ''); ?>>
                                                (GMT+09:00)
                                                Seoul</option>
                                            ...
                                            <option value="Australia/Adelaide"
                                                <?php echo e($tz ? ($tz == 'Australia/Adelaide' ? 'selected' : '') : ''); ?>>(GMT+09:30)
                                                Adelaide
                                            </option>
                                            ...
                                            <option value="Australia/Brisbane"
                                                <?php echo e($tz ? ($tz == 'Australia/Brisbane' ? 'selected' : '') : ''); ?>>(GMT+10:00)
                                                Brisbane
                                            </option>
                                            <option value="Australia/Canberra"
                                                <?php echo e($tz ? ($tz == 'Australia/Canberra' ? 'selected' : '') : ''); ?>>(GMT+10:00)
                                                Canberra,
                                            ...
                                            <option value="Pacific/Tongatapu"
                                                <?php echo e($tz ? ($tz == 'Pacific/Tongatapu' ? 'selected' : '') : ''); ?>>(GMT+13:00)
                                                Nuku'alofa
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-12">
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="input-label text-capitalize d-flex alig-items-center"><?php echo e(__('messages.time_format')); ?></label>
                                        <select name="time_format" class="form-control">
                                            <option value="12" <?php echo e($tf == '12' ? 'selected' : ''); ?>>
                                                <?php echo e(__('messages.12_hour')); ?>

                                            </option>
                                            <option value="24" <?php echo e($tf == '24' ? 'selected' : ''); ?>>
                                                <?php echo e(__('messages.24_hour')); ?>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"
                                            for="digit_after_decimal_point"><?php echo e(__('messages.Digit after decimal point')); ?></label>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"
                                        for="admin_comission_in_delivery_charge"><?php echo e(translate('Admin Comission in Delivery Charge')); ?></label>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center"> <span class="card-header-icon mr-2"><i class="tio-settings-outlined"></i></span> <span><?php echo e(__('messages.business')); ?> <?php echo e(__('messages.setting')); ?></span></h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="pr-2 d-flex align-items-center">
                                            <span class="line--limit-1"><?php echo e(__('messages.customer')); ?>

                                            <?php echo e(__('messages.verification')); ?></span><span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If you turn on this, customers have to verify their phone number through an OTP and you need to set up an SMS gateway before turning on this.')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span></span>
                                            <input type="checkbox" class="toggle-switch-input" value="1"
                                            name="customer_verification" <?php echo e($ev == 1 ? 'checked' : ''); ?>>
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control">
                                        <span class="pr-2 d-flex align-items-center">
                                            <span class="line--limit-1"><?php echo e(__('messages.restaurant_self_registration')); ?></span> <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If this field is active, restaurants can register themself using the restaurant app, user app, or website.')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span></span>
                                            <input type="checkbox" class="toggle-switch-input" value="1"
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="pr-2 d-flex align-items-center">
                                            ...
                                            <span class="line--limit-1"><?php echo e(__('messages.dm_self_registration')); ?></span><span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('When this field is active, delivery men can register themself using the delivery man app, user app, or website.')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span></span>
                                            <input type="checkbox" class="toggle-switch-input" value="1"
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control">
                                        <span class="pr-2 d-flex align-items-center"><span class="line--limit-1"><?php echo e(__('messages.admin')); ?>

                                            <?php echo e(__('messages.order')); ?> <?php echo e(__('messages.notification')); ?></span><span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Turning on this, admin will get a popup notification with sound for all orders.')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span></span>
                                            <input type="checkbox" class="toggle-switch-input" value="1"
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control">
                                        <span class="pr-2 d-flex align-items-center"><span class="line--limit-1"><?php echo e(__('messages.scheduled')); ?>

                                            <?php echo e(__('messages.orders')); ?></span><span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('After activating this field, customers are able to place scheduled orders.')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span></span>
                                            <input type="checkbox" value="1" name="schedule_order" class="toggle-switch-input" <?php echo e($schedule_order == 1 ? 'checked' : ''); ?>>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control">
                                        <span class="pr-2 d-flex align-items-center"><span class="line--limit-1"><?php echo e(__('messages.order')); ?>

                                            <?php echo e(__('messages.delivery')); ?> <?php echo e(__('messages.verification')); ?></span><span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If this field is active, customers have to provide a 4-digit code to the delivery man to deliver an order successfully. Customers will get this code in order details.')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span></span>
                                ...
                                <?php ($dm_tips_status = $dm_tips_status ? $dm_tips_status->value : 'deliveryman'); ?>
                                    <div class="form-group">
                                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control">
                                        <span class="pr-2 d-flex align-items-center"><span class="line--limit-1"><?php echo e(translate('DM Tips Option')); ?></span><span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If this option is enabled, the Delivery men Tip option will show on the user app & web app during order placement.')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span></span>
                                            <input type="checkbox" class="toggle-switch-input" value="1"
                                            name="dm_tips_status"
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control">
                                        <span class="pr-2 d-flex align-items-center"><span class="line--limit-1"><?php echo e(__('messages.show_earning_for_each_order')); ?>

                                            </span>
                                        <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If this field is enabled, the delivery man is able to see the earnings when accepting the order on the order request page.')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span></span>
                                            <input type="checkbox" class="toggle-switch-input" value="1"
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 px-xl-4 form-control">
                                        <span class="pr-2 d-flex align-items-center"><span class="line--limit-1"><?php echo e(translate('Veg / Non Veg Option')); ?></span><span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('When this field is active, the restaurants and the customers both can see the veg/non-veg tag.')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span></span>
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"><span class="line--limit-1"><?php echo e(__('messages.order_confirmation_model')); ?></span> <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('The chosen model will confirm the order first. For example, if you choose the delivery confirmation model then the delivery men will get the orders before the restaurants and confirm for delivery and after confirmation by the delivery men, the restaurants will get the order for processing.')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span></label>
                                        <div class="resturant-type-group border">
                                            ...
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                ...
                                                <span class="form-check-label">
                                                    <?php echo e(__('messages.deliveryman')); ?>
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"><span class="line--limit-1"><?php echo e(translate('Delivery Man can Cancel Order')); ?></span> <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Order cancellation is possible by the delivery person if "Yes" is chosen .')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span></label>
                                        <div class="resturant-type-group border">
                                            <label class="form-check form--check mr-2 mr-md-4">
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"><span class="line--limit-1"><?php echo e(translate('restaurant_can_cancel_order')); ?> </span><span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('Order cancellation is possible by the restaurant if "Yes" is chosen .')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span></label>
                                        <div class="resturant-type-group border">
                                            <label class="form-check form--check mr-2 mr-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"
                                            ...
                                            <span class="line--limit-1"><?php echo e(__('messages.Schedule order slot duration')); ?>

                                            <?php echo e(__('messages.minute')); ?></span><span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('The schedule order time slot will be managed by this value. For example, If you set 30 minutes in this section then you will see 10.30 to 11 or 11.00 to 11.30 or 11.30 to 12.00 when ordering user apps.')); ?>">
                                            <i class="tio-info-outined"></i>
                                            </span>
                                        </label>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"
                                            for="dm_maximum_orders"><span class="line--limit-1"><?php echo e(__('messages.dm_maximum_order')); ?></span>

                                        <span data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('The given number will be the maximum ongoing orders for a delivery man.')); ?>"
                                    class="input-label-secondary"><img
                                        src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                        alt="<?php echo e(__('messages.dm_maximum_order_hint')); ?>"></span>
                                        </label>
                                        <input type="number" name="dm_maximum_orders" class="form-control" id="dm_maximum_orders"
                                            min="1" value="<?php echo e($dm_maximum_orders ? $dm_maximum_orders->value : 1); ?>" required placeholder="Ex: +9XXX-XXX-XXXX">
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="free_delivery_over" class="form-control"
                                            ...
                                            step=".01" placeholder="Ex: 100" required <?php echo e(isset($free_delivery_over->value) ? '' : 'readonly'); ?>>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"
                                            for="minimum_shipping_charge"><?php echo e(__('messages.minimum_shipping_charge')); ?></label>
                                        <input type="number" name="minimum_shipping_charge" class="form-control"
                                            id="minimum_shipping_charge" min="0" step=".01"
                                            value="<?php echo e($minimum_shipping_charge ? $minimum_shipping_charge->value : 0); ?>" placeholder="Ex: 50"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"
                                            for="per_km_shipping_charge"><?php echo e(__('messages.per_km_shipping_charge')); ?>

                                        </label>
                                        <input type="number" name="per_km_shipping_charge" class="form-control"
                                            id="per_km_shipping_charge" min="0" step=".01"
                                            value="<?php echo e($per_km_shipping_charge ? $per_km_shipping_charge->value : 0); ?>" placeholder="Ex: 50" required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label d-flex text-capitalize"
                                            ...
                                            <span class="line--limit-1">
                                                <?php echo e(translate('Delivery Man Maximum Cash in Hand')); ?> (<?php echo e(\App\CentralLogics\Helpers::currency_symbol()); ?>)
                                            </span>

                                            <span data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If the cash in hand for a delivery man exceeds this amount the delivery man cannot accept new orders before depositing the amount to admin.')); ?>" class="input-label-secondary"><img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(__('messages.dm_maximum_order_hint')); ?>"></span>

                                        </label>
                                        <input type="number" name="dm_max_cash_in_hand" class="form-control"
                                            id="dm_max_cash_in_hand" min="0" step=".01"
                                             value="<?php echo e($dm_max_cash_in_hand ? $dm_max_cash_in_hand->value : 0); ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="btn--container justify-content-end">
                                ...
                                class="btn btn--primary mb-2"><i class="tio-save-outlined mr-2"></i><?php echo e(trans('messages.save')); ?> <?php echo e(__('messages.info')); ?></button>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/admin-views/business-settings/business-index.blade.php ENDPATH**/ ?>