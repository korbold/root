        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-md-auto mb-md-0 mb-3 mr-auto">
                    <h1 class="page-header-title"> <?php echo e(__('messages.food')); ?> <?php echo e(__('messages.list')); ?><span
                ...
                <?php if($toggle_veg_non_veg): ?>
                    ...
                    <div class="col-md-auto mb-3 mb-md-0">
                        <select name="category_id" onchange="set_filter('<?php echo e(url()->full()); ?>',this.value, 'type')"
                            data-placeholder="<?php echo e(__('messages.all')); ?>" class="form-control">
                            ...
                            <option value="non_veg" <?php echo e($type == 'non_veg' ? 'selected' : ''); ?>><?php echo e(__('messages.non_veg')); ?>
                ...
                <div class="col-md-auto mb-3 mb-md-0 min-240">
                    <select name="restaurant_id" id="restaurant"
                        ...
                        <?php else: ?>
                            <option value="all" selected><?php echo e(__('messages.all_restaurants')); ?></option>
                        <?php endif; ?>
                    </select>
                </div>
                <div class="col-md-auto mb-3 mb-md-0 min-240">
                    ...
                    <div class="hs-unfold w-100">
                        <select name="category_id" id="category"
                            ...
                            data-placeholder="<?php echo e(__('messages.select_category')); ?>"
                            class="js-data-example-ajax form-control">
                            <?php if($category): ?>
                                <option value="<?php echo e($category->id); ?>" selected><?php echo e($category->name); ?>

                                    (<?php echo e($category->position == 0 ? __('messages.main') : __('messages.sub')); ?>)
                                </option>
                            <?php else: ?>
                                ...
                                <div id="showHideDropdown"
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span class="mr-2"><?php echo e(__('messages.category')); ?></span>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span class="mr-2"><?php echo e(__('messages.status')); ?></span>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span class="mr-2"><?php echo e(__('messages.price')); ?></span>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span class="mr-2"><?php echo e(__('messages.action')); ?></span>
                        ...
                        <table id="datatable"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="w-100px"><?php echo e(__('messages.name')); ?></th>
                                    <th class="w-120px"><?php echo e(__('messages.category')); ?></th>
                                    <th class="w-120px"><?php echo e(__('messages.restaurant')); ?></th>
                                    <th class="w-100px"><?php echo e(__('messages.price')); ?></th>
                                    <th class="w-100px"><?php echo e(__('messages.status')); ?></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($food->restaurant): ?>
                                                <a class="text--title" href="<?php echo e(route('admin.vendor.view',['restaurant'=>$food->restaurant_id])); ?>" title="<?php echo e(translate('view_restaurant')); ?>">
                                                    <?php echo e(Str::limit($food->restaurant->name, 20, '...')); ?>

                                                </a>
                                            <?php else: ?>
                                                <span class="text--danger text-capitalize"><?php echo e(Str::limit( __('messages.Restaurant deleted!'), 20, '...')); ?><span>
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn btn-sm btn--primary btn-outline-primary action-btn"
                                                    ...
                                                    title="<?php echo e(__('messages.edit')); ?> <?php echo e(__('messages.food')); ?>"><i
                                                        class="tio-edit"></i>
                                                </a>
                                                <a class="btn btn-sm btn--warning btn-outline-warning action-btn" href="javascript:"
                                                    onclick="form_alert('food-<?php echo e($food['id']); ?>','<?php echo e(__('messages.Want_to_delete_this_item')); ?>')"
                                                    title="<?php echo e(__('messages.delete')); ?> <?php echo e(__('messages.food')); ?>"><i
...
<?php $__env->startPush('script_2'); ?>
    <script>
        ...
        $('#search-form').on('submit', function(e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.food.search')); ?>',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/admin-views/product/list.blade.php ENDPATH**/ ?>