            ...
            <div class="col-md-4 col-sm-6">
                <div class="grid-card top-selling-food-card pt-0" onclick="location.href='<?php echo e(route('admin.food.view',[$item['id']])); ?>'">
                    <div class="position-relative">
                        <span class="sold--count-badge"><?php echo e(__('messages.sold')); ?> : <?php echo e($item['order_count']); ?></span>
...
<!-- End Body -->
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/admin-views/partials/_top-selling-foods.blade.php ENDPATH**/ ?>