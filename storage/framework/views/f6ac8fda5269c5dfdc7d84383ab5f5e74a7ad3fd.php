...
<div class="card-header">
    <h5 class="card-header-title">
        ...
        <span><?php echo e(translate('Top Deliveryman')); ?></span>
    </h5>
            ...
            <div class="col-md-4 col-6" onclick="location.href='<?php echo e(route('admin.delivery-man.preview',[$item['id']])); ?>'">
                <div class="grid-card top--deliveryman">
                    ...
                    <div class="text-center mt-2">
                        <h5 class="name m-0"><?php echo e($item['f_name']??'Not exist'); ?></h5>
...
<!-- End Body -->
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/admin-views/partials/_top-deliveryman.blade.php ENDPATH**/ ?>