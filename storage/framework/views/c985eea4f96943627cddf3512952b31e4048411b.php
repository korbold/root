    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title mb-2 text-capitalize">
                ...
                <span>
                    <?php echo e(str_replace('_',' ',$status)); ?> <?php echo e(__('messages.orders')); ?>
                ...
                <div class="search--button-wrapper justify-content-end">
                    <form action="javascript:" id="search-form" class="my-2 ml-auto mr-sm-2 mr-xl-4 ml-sm-auto flex-grow-1 flex-grow-sm-0">
                        ...
                        <div class="input--group input-group input-group-merge input-group-flush">
                            <input id="datatableSearch_" type="search" name="search" class="form-control"
                                    placeholder="Ex : Search your order..." aria-label="<?php echo e(__('messages.search')); ?>" required>
                    ...
                    <div class="hs-unfold">
                        <a class="js-hs-unfold-invoker btn btn-sm btn-white" href="javascript:;"
                            ...
                            <i class="tio-filter-list mr-1"></i><?php echo e(translate('filters')); ?> <span class="badge badge-success badge-pill ml-1" id="filter_count"></span>
                        </a>
                    </div>
                    <!-- End Unfold -->
                    <!-- Unfold -->
            ...
            <div class="table-responsive datatable-custom fz--14px">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th class="table-column-pl-0 w-90px"><?php echo e(__('messages.order')); ?> ID</th>
                        <th class="w-140px"><?php echo e(__('messages.order')); ?> <?php echo e(__('messages.date')); ?></th>
                        <th class="w-130px"><?php echo e(__('messages.customer')); ?> Info</th>
                        <th class="w-140px"><?php echo e(__('messages.restaurant')); ?></th>
                        <th class="w-120px"><?php echo e(__('messages.total')); ?> <?php echo e(__('messages.amount')); ?></th>
                        <th class="text-center w-120px"><?php echo e(__('messages.order')); ?> <?php echo e(__('messages.status')); ?></th>
                        <th class="text-center w-100px"><?php echo e(__('messages.actions')); ?></th>
                    </tr>
                    </thead>
                    ...
                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="status-<?php echo e($order['order_status']); ?> class-all">
                            ...
                            <td>
                                <label class="m-0">
                                    <a href="<?php echo e(route('admin.vendor.view', $order->restaurant_id)); ?>" class="text--title" alt="view restaurant">
                                        <?php echo e(Str::limit($order->restaurant?$order->restaurant->name:__('messages.Restaurant deleted!'),20,'...')); ?>
                            ...
                            <td class="text-capitalize text-center">
                                ...
                                <?php else: ?>
                                    <span>
                                        <?php echo e(translate('home_delivery')); ?>
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    <a class="ml-2 btn btn-sm btn--warning btn-outline-warning action-btn" href="<?php echo e(route('admin.order.details',['id'=>$order['id']])); ?>"><i class="tio-invisible"></i></a>

                                    <a class="ml-2 btn btn-sm btn--primary btn-outline-primary download--btn action-btn" href=<?php echo e(route('admin.order.generate-invoice', [$order['id']])); ?>><i class="tio-print"></i></a>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="card card-lg sidebar-card sidebar-footer-fixed">
                ...
                <form class="card-body sidebar-body sidebar-scrollbar" action="<?php echo e(route('admin.order.filter')); ?>" method="POST" id="order_filter_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 text-center"><?php echo e(translate('----to----')); ?></div>
                        <div class="col-12">
                    ...
                    <div class="card-footer sidebar-footer">
                        <div class="row gx-2">
                            <div class="col">
                                <button type="reset" class="btn btn-block btn-white" id="reset"> <?php echo e(translate('clear_all_filters')); ?></button>
                            </div>
                            <div class="col">
            ...
            var datatable = $.HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                buttons: [
                    ...
                    // },
                    {
                        ...
                        {
                            window.location.href = '<?php echo e(route("admin.order.export",['status'=>$status,'type'=>'excel'])); ?>';
                        }
                    },
                    {
                        extend: 'csv',
                        ...
                        action: function (e, dt, node, config)
                        {
                            window.location.href = '<?php echo e(route("admin.order.export",['status'=>$status,'type'=>'csv'])); ?>';
                        }
                    },
                    // {
                    //     extend: 'pdf',
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/admin-views/order/list.blade.php ENDPATH**/ ?>