        ...
        <div class="col-md-4 col-6">
            <div class="grid-card top--rated-food pb-4 cursor-pointer" onclick="location.href='<?php echo e(route('admin.food.view',[$item['id']])); ?>'">
                ...
                <div class="text-center mt-3">
                    <h5 class="name m-0 mb-1"><?php echo e(Str::limit($item->name??__('messages.Food deleted!'),20,'...')); ?></h5>
                    <div class="rating">
...
<!-- End Body -->
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/admin-views/partials/_top-rated-foods.blade.php ENDPATH**/ ?>