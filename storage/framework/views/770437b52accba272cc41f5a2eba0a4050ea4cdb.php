        ...
        <div class="row">
            <div class="col-lg-3">
                ...
                <span class="d-flex justify-content-between align-items-center">
                  <span class="h5 mb-0"><?php echo e(__('messages.nav_menu')); ?></span>
            ...
            <div class="col-lg-9">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h2 class="card-title h4">
                                <i class="tio-info"></i> <?php echo e(__('messages.basic_information')); ?>
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-sm-down-break">
                                        <input type="text" class="form-control h--45px" name="f_name" id="firstNameLabel"
                                               placeholder="Ex: Jhone" aria-label="<?php echo e(__('messages.your_first_name')); ?>"
                                               value="<?php echo e(auth('admin')->user()->f_name); ?>">
                                        <input type="text" class="form-control h--45px" name="l_name" id="lastNameLabel"
                                               placeholder="Ex: Doe" aria-label="<?php echo e(__('messages.your_last_name')); ?>"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control h--45px" name="email" id="newEmailLabel"
                                           ...
                                           placeholder="Ex: jhone@company.com" aria-label="<?php echo e(__('messages.enter_new_email_address')); ?>">
                                </div>
                            </div>
                ...
                <div id="passwordDiv" class="card mb-3">
                    <div class="card-header">
                        <h4 class="card-title"><i class="tio-lock"></i> <?php echo e(__('messages.change_your_password')); ?></h4>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/admin-views/settings.blade.php ENDPATH**/ ?>