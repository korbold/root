        ...
        <div class="container__payment">
            ...
            <div class="form-payment">
                <div class="products">
                    ...
                    <div class="total"><?php echo e(__('messages.amount_to_be_paid')); ?><span class="price"><?php echo e(\App\CentralLogics\Helpers::format_currency($order->order_amount)); ?></span></div>
                </div>
...
<script>
    ...
    function loadCardForm() {
        const productCost = '<?php echo e($order->order_amount); ?>';
        ...
        const cardForm = mercadopago.cardForm({
            ...
            form: {
                ...
                cardholderName: {
                    ...
                    placeholder: "<?php echo e(__('messages.card_holder_name')); ?>",
                },
                cardholderEmail: {
                    id: "form-checkout__cardholderEmail",
                    placeholder: "<?php echo e(__('messages.card_holder_email')); ?>",
                },
                cardNumber: {
                    id: "form-checkout__cardNumber",
                    placeholder: "<?php echo e(__('messages.card_number')); ?>",
                },
                cardExpirationMonth: {
                ...
                securityCode: {
                    ...
                    placeholder: "<?php echo e(__('messages.security_code')); ?>",
                },
                installments: {
                    id: "form-checkout__installments",
                    placeholder: "<?php echo e(__('messages.installments')); ?>",
                },
                identificationType: {
                ...
                identificationNumber: {
                    ...
                    placeholder: "<?php echo e(__('messages.identification_number')); ?>",
                },
                issuer: {
                    id: "form-checkout__issuer",
                    placeholder: "<?php echo e(__('messages.issuer')); ?>",
                },
            },
            callbacks: {
                onFormMounted: error => {
                ...
                onSubmit: event => {
                    ...
                    fetch("<?php echo e(route('mercadopago.make_payment')); ?>", {
                        method: "POST",
                        headers: {
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/payment-view-marcedo-pogo.blade.php ENDPATH**/ ?>