        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-notice"></i> <?php echo e(__('messages.food')); ?> <?php echo e(__('messages.campaign')); ?> <span class="badge badge-soft-dark ml-2" id="itemCount"><?php echo e($campaigns->total()); ?></span></h1>
                </div>
                    ...
                    <div class="card-header py-2 border-0">
                        ...
                        <form id="search-form">
                            ...
                            <div class="input--group input-group input-group-merge input-group-flush">
                                <input id="datatableSearch" type="search" name="search" class="form-control" placeholder="Ex : <?php echo e(__('messages.title')); ?>" aria-label="<?php echo e(__('messages.search_here')); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="campaignCheckbox<?php echo e($campaign->id); ?>">
                                            <input type="checkbox" onclick="location.href='<?php echo e(route('admin.campaign.status',['item',$campaign['id'],$campaign->status?0:1])); ?>'"class="toggle-switch-input" id="campaignCheckbox<?php echo e($campaign->id); ?>" <?php echo e($campaign->status?'checked':''); ?>>
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            <a class="btn btn-sm btn--primary btn-outline-primary action-btn"
                                                href="<?php echo e(route('admin.campaign.edit',['item',$campaign['id']])); ?>" title="<?php echo e(__('messages.edit')); ?> <?php echo e(__('messages.campaign')); ?>"><i class="tio-edit"></i>
                                            </a>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/admin-views/campaign/item/list.blade.php ENDPATH**/ ?>