...
<head>
    ...
    <!-- Title -->
    <title><?php echo e(__('messages.error')); ?> 500 | <?php echo e(\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()->value??'Stack Food'); ?></title>
    ...
    <div class="footer-height-offset d-flex justify-content-center align-items-center flex-column">
        <div class="row align-items-sm-center w-100">
            ...
            <div class="col-sm-6 col-md-4 text-center text-sm-left">
                ...
                <p class="lead"><?php echo e(__('messages.500_warning_message')); ?></p>
                <a class="btn btn-primary" href="<?php echo e(url()->current()); ?>"><?php echo e(__('messages.reload_page')); ?></a>
            </div>
        </div>
        <!-- End Row -->
    </div>
...
<div class="footer text-center">
    <ul class="list-inline list-separator">
        <li class="list-inline-item">
            <a class="list-separator-link" target="_blank" href="https://6amtech.com/"><?php echo e(\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()->value??'Stack Food'); ?> <?php echo e(__('messages.support')); ?></a>
        </li>
    </ul>
</div>
<!-- End Footer -->
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/errors/500.blade.php ENDPATH**/ ?>