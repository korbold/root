...
<?php elseif($conv->receiver && $conv->receiver->deliveryman_id): ?>
<?php ($user=\App\Models\DeliveryMan::find($conv->receiver->deliveryman_id)); ?>
<?php ($last_sender=$conv->receiver->id); ?>
<?php elseif($conv->sender && $conv->sender->user_id): ?>
<?php ($user=\App\Models\User::find($conv->sender->user_id)); ?>
<?php ($last_sender=$conv->sender->id); ?>
<?php elseif($conv->sender && $conv->sender->deliveryman_id): ?>
...
<?php if($user): ?>
    ...
    <div
        ...
        onclick="viewConvs('<?php echo e(route('vendor.message.view',['conversation_id'=>$conv->id,'user_id'=>$conv->sender_id])); ?>','customer-<?php echo e($conv->sender_id); ?>','<?php echo e($conv->id); ?>','<?php echo e($conv->sender_id); ?>')"
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/vendor-views/messages/data.blade.php ENDPATH**/ ?>