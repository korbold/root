    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <input type="text" class="form-control" name="choice[]" value="<?php echo e($choice['title']); ?>"
                   placeholder="<?php echo e(__('messages.choice_title')); ?>" readonly>
        </div>
        <div class="col-lg-9">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/admin-views/product/partials/_choices.blade.php ENDPATH**/ ?>