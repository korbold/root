            ...
            <div class="d-flex justify-content-end">
                ...
                <ul class="list-inline list-separator d-flex flex-wrap justify-content-evenly justify-content-md-end flex-grow-1">
                    <li class="list-inline-item py-1">
                        <a class="list-separator-link" href="<?php echo e(route('admin.business-settings.business-setup')); ?>"><?php echo e(__('messages.business')); ?> <?php echo e(__('messages.setup')); ?> <i class="tio-settings-outlined ml-xl-2"></i></a>
                    </li>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/root/resources/views/layouts/admin/partials/_footer.blade.php ENDPATH**/ ?>